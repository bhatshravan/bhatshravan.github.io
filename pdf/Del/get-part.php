...
<body>
	...
	$query = "SELECT * FROM del WHERE id=".$yn;
	...
	$userData = array();
	 ...
	 style='box-shadow:inset 1px -1px 1px #444, inset -1px 1px 1px #444;'><thead><tr><th>ID</th><th>NAME</th><th>Address</th><th>PIN</th><th>Status</th></tr></thead><tbody>";
